...
const queryURL = "https://rest.bandsintown.com/artists/" + userInput + "/events?app_id=" + bandsintown;
request(queryURL, {
    json: true
}, (err, res, body) => {
    if (err) {
        ...
        let bitLocation = body[i].venue.city + ", " + body[i].venue.region + ", " + body[i].venue.country;
